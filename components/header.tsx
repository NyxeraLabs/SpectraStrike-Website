      ...
      <Container className="flex min-h-16 items-center justify-between gap-3 py-3 lg:min-h-20">
        <Link href="/" className="flex min-w-0 items-center gap-2 text-foreground">
          <div className="relative h-10 w-10 shrink-0 sm:h-12 sm:w-12">
            <Image src="/images/spectrastrike-logo-official.png" alt="SpectraStrike logo" fill className="object-contain" priority />
          </div>
          <span className="truncate pl-1 text-xs font-semibold tracking-[0.02em] text-foreground sm:text-sm lg:pl-2">
